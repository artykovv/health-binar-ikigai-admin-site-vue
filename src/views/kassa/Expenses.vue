                ...
                <td class="px-4 py-3 text-sm">
                  <div class="flex flex-wrap gap-1">
                    <span 
                      ...
                      :key="tag.id"
                      class="px-2 py-0.5 rounded-full text-[10px] font-medium bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300"
                    >
                      {{ tag.name }}
                    </span>
...
const editExpense = (tx) => {
  ...
  // Если при редактировании массив платежей пустой (старая запись или баг), добавим строку
