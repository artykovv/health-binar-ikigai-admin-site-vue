        ...
        <div class="p-2">
          <nav class="flex space-x-8 justify-center">
            ...
            <template v-if="isActive('/products')">
              ...
              <router-link 
                to="/products/warehouses" 
                class="py-2 px-1 border-b-2 font-medium text-sm transition-colors"
                :class="isActive('/products/warehouses') ? 'border-gray-900 text-gray-900 dark:text-gray-100 dark:border-gray-100' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300'"
              >
                Склады
              </router-link>
              <router-link 
                to="/products/inventory-movements" 
                class="py-2 px-1 border-b-2 font-medium text-sm transition-colors"
                :class="isActive('/products/inventory-movements') ? 'border-gray-900 text-gray-900 dark:text-gray-100 dark:border-gray-100' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300'"
              >
                Движение товаров
              </router-link>
            </template>
